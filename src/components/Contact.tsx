...
export function Contact() {
  return (
    <section id="contacto" className="scroll-mt-24 bg-zinc-950 py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-2 break-all text-sm font-medium text-white group-hover:text-fuchsia-200">
              {profile.email}
            </p>
          </a>
          <a
